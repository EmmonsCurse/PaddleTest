...
def check_model_exist():
    ...
    check model exist
    """
    swin_transformer_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/swin_transformer.tgz"
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1-2 swin_transformer outputs with true val
    """
    check_model_exist()
