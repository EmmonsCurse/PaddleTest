...
"""
test ViT_base_patch16_224 model
"""
...
def check_model_exist():
    ...
    check model exist
    """
    ViT_base_patch16_224_url = "https://paddle-qa.bj.bcebos.com/inference_model/2.3.2/class/ViT_base_patch16_224.tgz"
    if not os.path.exists("./ViT_base_patch16_224/inference.pdiparams"):
        wget.download(ViT_base_patch16_224_url, out="./")
        tar = tarfile.open("ViT_base_patch16_224.tgz")
        tar.extractall()
        tar.close()
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1 ViT_base_patch16_224 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp16_bz1_multi_thread():
    """
    compared trt fp16 batch_size=1 ViT_base_patch16_224 multi_thread outputs with true val
    """
    check_model_exist()
