...
def check_model_exist():
    ...
    check model exist
    """
    ViT_base_patch32_384_url = "https://paddle-qa.bj.bcebos.com/inference_model/2.3.2/class/ViT_base_patch32_384.tgz"
...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1 ViT_base_patch32_384 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp32_bz1_multi_thread():
    """
    compared trt fp32 batch_size=1 ViT_base_patch32_384 multi_thread outputs with true val
    """
    check_model_exist()
