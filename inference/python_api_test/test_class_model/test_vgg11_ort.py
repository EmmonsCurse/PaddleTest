...
def check_model_exist():
    ...
    check model exist
    """
    vgg11_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/vgg11.tgz"
...
def test_onnxruntime():
    """
    compared onnxruntime batch_size=1 vgg11 outputs with true val
    """
    check_model_exist()
