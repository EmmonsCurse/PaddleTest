...
def check_model_exist():
    ...
    check model exist
    """
    resnet50_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest/class/resnet50.tgz"
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1-2 resnet50 outputs with true val
    """
    check_model_exist()
