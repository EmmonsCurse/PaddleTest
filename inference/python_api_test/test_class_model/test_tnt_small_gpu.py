...
def check_model_exist():
    ...
    check model exist
    """
    tnt_small_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/TNT_small.tgz"
...
def test_gpu_mixed_precision_bz1():
    ...
    for batch_size in batch_size_pool:
        ...
        test_suite2 = InferenceTest()
        test_suite2.load_config(
            model_file="./TNT_small/inference_mixed.pdmodel",
            params_file="./TNT_small/inference_mixed.pdiparams",
        )
