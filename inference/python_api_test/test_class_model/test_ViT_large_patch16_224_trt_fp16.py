...
"""
test ViT_large_patch16_224 model
"""
...
def check_model_exist():
    ...
    check model exist
    """
    ViT_large_patch16_224_url = "https://paddle-qa.bj.bcebos.com/inference_model/2.3.2/class/ViT_large_patch16_224.tgz"
...
def test_config():
    ...
    test_suite.load_config(
        model_file="./ViT_large_patch16_224/inference.pdmodel",
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1 ViT_large_patch16_224 outputs with true val
    """
    check_model_exist()

    file_path = "./ViT_large_patch16_224"
    images_size = 224
    batch_size_pool = [1]
    max_batch_size = 1
...
def test_trt_fp16_bz1_multi_thread():
    """
    compared trt fp16 batch_size=1 ViT_large_patch16_224 multi_thread outputs with true val
    """
    check_model_exist()
