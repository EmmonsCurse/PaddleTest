...
"""
test inference_model/2.3.2 model
"""
...
def test_trt_fp32_more_bz():
    """
    compared trt fp32 batch_size=1 ViT_large_patch16_384 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp32_bz1_multi_thread():
    """
    compared trt fp32 batch_size=1 ViT_large_patch16_384 multi_thread outputs with true val
    """
    check_model_exist()
