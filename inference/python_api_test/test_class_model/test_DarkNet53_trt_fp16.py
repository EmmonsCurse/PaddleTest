...
def check_model_exist():
    ...
    check model exist
    """
    DarkNet53_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/DarkNet53.tgz"
...
def test_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1-2 DarkNet53 outputs with true val
    """
    check_model_exist()
...
def test_jetson_trt_fp16_more_bz():
    """
    compared trt fp16 batch_size=1 DarkNet53 outputs with true val
    """
    check_model_exist()
...
def test_trt_fp16_bz1_multi_thread():
    """
    compared trt fp16 batch_size=1 DarkNet53 multi_thread outputs with true val
    """
    check_model_exist()
