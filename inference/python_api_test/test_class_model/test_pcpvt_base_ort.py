...
def check_model_exist():
    ...
    check model exist
    """
    pcpvt_base_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/pcpvt_base.tgz"
...
def test_onnxruntime():
    """
    compared onnxruntime batch_size=1 pcpvt_base outputs with true val
    """
    check_model_exist()
