...
def check_model_exist():
    ...
    check model exist
    """
    GoogLeNet_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/class/GoogLeNet.tgz"
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 batch_size=1 GoogLeNet outputs with true val
    """
    check_model_exist()
