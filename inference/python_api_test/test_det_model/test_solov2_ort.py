...
def check_model_exist():
    ...
    check model exist
    """
    solov2_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/detection/solov2.tgz"
...
def test_more_bz_onnxruntime():
    """
    compared onnxruntime solov2 batch_size = [1] outputs with true val
    """
    check_model_exist()
