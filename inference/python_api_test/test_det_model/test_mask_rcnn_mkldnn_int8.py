...
def check_model_exist():
    ...
    check model exist
    """
    mask_rcnn_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest/detection/mask_rcnn.tgz"
...
def test_mkldnn_int8_more_bz():
    """
    compared mkldnn_int8 mask_rcnn batch_size = [1] outputs with true val
    """
    check_model_exist()
