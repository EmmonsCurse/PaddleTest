...
def check_model_exist():
    ...
    check model exist
    """
    fast_rcnn_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/detection/fast_rcnn.tgz"
...
@pytest.mark.win
@pytest.mark.server
@pytest.mark.mkldnn_int8_more
def test_mkldnn_int8_more_bz():
    """
    compared mkldnn_int8 fast_rcnn batch_size = [1] outputs with true val
    """
    check_model_exist()
