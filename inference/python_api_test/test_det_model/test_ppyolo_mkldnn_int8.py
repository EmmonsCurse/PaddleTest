...
def check_model_exist():
    ...
    check model exist
    """
    ppyolo_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest/detection/ppyolo.tgz"
...
def test_mkldnn_int8():
    """
    compared mkldnn_int8 ppyolo batch_size = [1] outputs with true val
    """
    check_model_exist()
