...
def check_model_exist():
    ...
    check model exist
    """
    yolov3_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/detection/yolov3.tgz"
...
@pytest.mark.win
@pytest.mark.server
@pytest.mark.mkldnn_int8_more_bz_precision
def test_more_bz_mkldnn_int8():
    """
    compared mkldnn_int8 yolov3 batch size = [1, 2] outputs with true val
    """
    check_model_exist()
