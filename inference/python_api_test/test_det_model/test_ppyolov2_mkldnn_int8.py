...
def check_model_exist():
    ...
    check model exist
    """
    ppyolov2_url = "https://paddle-qa.bj.bcebos.com/inference_model_clipped/latest_release/detection/ppyolov2.tgz"
...
def test_more_bz_mkldnn_int8():
    """
    compared mkldnn_int8 ppyolov2 batch_size = [1] outputs with true val
    """
    check_model_exist()
